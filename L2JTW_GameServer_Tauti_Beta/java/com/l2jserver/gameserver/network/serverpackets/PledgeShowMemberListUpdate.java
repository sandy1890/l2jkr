...
public final class PledgeShowMemberListUpdate extends L2GameServerPacket {
	...
	private final int _isOnline; // rocknow-God
	...
	public PledgeShowMemberListUpdate(L2PcInstance player) {
		...
		_isOnline = player.isOnline() ? 1 : 0; // rocknow-God
	}
	...
	public PledgeShowMemberListUpdate(L2ClanMember member) {
		...
		_isOnline = member.isOnline() ? 1 : 0; // rocknow-God
	...
	protected final void writeImpl() {
		...
		writeD(_sex);
		writeD(_objectId);
		writeD(_isOnline); // rocknow-God
		writeD(_pledgeType); // rocknow-God
		writeD(_hasSponsor); // rocknow-God
	}
