...
public abstract class AbstractNpcInfo extends L2GameServerPacket {
	...
	public static class NpcInfo extends AbstractNpcInfo {
		...
		public NpcInfo(L2Npc cha, L2Character attacker) {
			...
			if (Config.SHOW_NPC_LVL && (_npc instanceof L2MonsterInstance)) {
				/*
				 * Move To MessageTable For L2JTW String t = "Lv " + cha.getLevel() + (cha.getAggroRange() > 0 ? "*" : "");
				 */
		...
		protected void writeImpl() {
			...
			/*
			 * l2jtw start writeD(0x02); //rocknow-God AbnormalEffect-Number writeD(_npc.getAbnormalEffect()); //rocknow-God writeD(_npc.getSpecialEffect()); //rocknow-God
			 */
	...
	public static class TrapInfo extends AbstractNpcInfo {
		...
		protected void writeImpl() {
			...
			writeF(0x01); // rocknow-God
			/*
			 * l2jtw start writeD(0x02); //rocknow-God AbnormalEffect-Number writeD(_trap.getAbnormalEffect()); //rocknow-God writeD(_trap.getSpecialEffect()); //rocknow-God
			 */
	...
	public static class SummonInfo extends AbstractNpcInfo {
		...
		protected void writeImpl() {
			...
			writeF(0x01); // rocknow-God
			/*
			 * l2jtw start writeD(0x02); //rocknow-God AbnormalEffect-Number writeD(gmSeeInvis ? _summon.getAbnormalEffect() | AbnormalEffect.STEALTH.getMask() : _summon.getAbnormalEffect()); //rocknow-God writeD(_summon.getSpecialEffect()); //rocknow-God
			 */
