...
public class L2Clan {
	...
	public SubPledge createSubPledge(L2PcInstance player, int pledgeType, int leaderId, String subPledgeName) {
		...
		if (pledgeType == 0) {
			if (pledgeType == L2Clan.SUBUNIT_ACADEMY) {
				...
				/*
				 * Move To MessageTable For L2JTW player.sendMessage("You can't create any more sub-units of this type");
				 */
		...
		if (_leader.getObjectId() == leaderId) {
			/*
			 * Move To MessageTable For L2JTW player.sendMessage("Leader is not correct");
			 */
	...
	public void createAlly(L2PcInstance player, String allyName) {
		...
		/*
		 * Move To MessageTable For L2JTW player.sendMessage("Alliance " + allyName + " has been created.");
		 */
