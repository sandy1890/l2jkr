		...
		if (actualCommand.equalsIgnoreCase("create_clan")) {
			...
			switch (cmdChoice) {
				...
				case 3: // Change/Cancel Subclass - Initial
					...
					if (player.getTotalSubClasses() > 3) {
						...
						for (Iterator<SubClass> subList = iterSubClasses(player); subList.hasNext();) {
							...
							/*
							 * Move To MessageTable For L2JTW "Sub-class ",
							 */
							MessageTable.Messages[759].getMessage(), String.valueOf(classIndex++), "<br>", "<a action=\"bypass -h npc_%objectId%_Subclass 6 ", String.valueOf(subClass.getClassIndex()), "\">", ClassListData.getInstance().getClass(subClass.getClassId()).getClientCode(), "</a><br>");
						}
				...
				case 5: // Change Class - Action
					 ...
					 * l2jtw start
					 */
					// player.setActiveClass(paramOne); player.sendPacket(SystemMessageId.SUBCLASS_TRANSFER_COMPLETED); // Transfer completed.
					{
