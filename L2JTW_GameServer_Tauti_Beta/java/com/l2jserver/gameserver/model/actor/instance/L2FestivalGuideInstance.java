...
public final class L2FestivalGuideInstance extends L2Npc {
	...
	private static final String getStatsTable() {
		...
		for (int i = 0; i < 5; i++) {
			...
			/*
			 * Move To MessageTable For L2JTW String winningCabal = "Children of Dusk";
			 */
			String winningCabal = MessageTable.Messages[638].getMessage();
			
			if (dawnScore > duskScore) {
				/*
				 * Move To MessageTable For L2JTW winningCabal = "Children of Dawn";
				 */
				winningCabal = MessageTable.Messages[639].getMessage();
			} else if (dawnScore == duskScore) {
				/*
				 * Move To MessageTable For L2JTW winningCabal = "None";
				 */
				winningCabal = MessageTable.Messages[640].getMessage();
			}
