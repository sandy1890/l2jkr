...
public class L2WeddingManagerInstance extends L2Npc {
	...
	public void onBypassFeedback(L2PcInstance player, String command) {
		...
		if (player.isMarried()) {
			...
			/*
			 * Move To MessageTable For L2JTW player.sendMessage("Congratulations you are married!");
			 */
			player.sendMessage(765);
			player.setMarried(true);
			player.setMarryRequest(false);
			/*
			 * Move To MessageTable For L2JTW ptarget.sendMessage("Congratulations you are married!");
			 */
			ptarget.sendMessage(765);
			...
			/*
			 * Move To MessageTable For L2JTW Announcements.getInstance().announceToAll("Congratulations to " + player.getName() + " and " + ptarget.getName() + "! They have been married.");
			 */
			Announcements.getInstance().announceToAll(MessageTable.Messages[766].getExtra(1) + player.getName() + MessageTable.Messages[766].getExtra(2) + ptarget.getName() + MessageTable.Messages[766].getExtra(3));
			...
			/*
			 * Move To MessageTable For L2JTW player.sendMessage("You declined your partner's marriage request."); ptarget.sendMessage("Your partner declined your marriage request.");
			 */
			player.sendMessage(767);
			ptarget.sendMessage(768);
