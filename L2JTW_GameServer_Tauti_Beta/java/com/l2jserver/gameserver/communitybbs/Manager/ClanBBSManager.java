...
public class ClanBBSManager extends BaseBBSManager
{
		...
		if (cl != null)
		{
			...
			else
			{
				final StringBuilder html = StringUtil.startAppend(2000, "<html><body><br><br>"
						...
						*/
						+ "<a action=\"bypass _bbshome\">"+MessageTable.Messages[53].getMessage()+"</a> &gt; "
						+ "<a action=\"bypass _bbsclan_clanlist\"> &amp;$809; </a>  &gt; " + "<a action=\"bypass _bbsclan_clanhome;", String.valueOf(clanId), "\"> &amp;$802; </a>"
						+ "</td></tr>" + "</table>");
				if (activeChar.isClanLeader())
				{
					StringUtil.append(html, "<br><br><center>"
							...
							*/
							+ "<tr><td fixwidth=610><font color=\"AAAAAA\">"+MessageTable.Messages[54].getMessage()+"</font> </td></tr>"
					...
					StringUtil.append(html, "</td></tr>"
							...
							*/
							+ "<tr><td>"+MessageTable.Messages[56].getMessage()+"</td></tr>"
				...
				else
				{
					...
					if (activeChar.getClan().isNoticeEnabled())
					{
						StringUtil.append(html, "<table border=0 cellspacing=0 cellpadding=0>" + "<tr>"
								...
								*/
								+ "<td>"+MessageTable.Messages[69].getMessage()+"</td>" + "</tr>" + "<tr><td fixwidth=5></td>"
	...
	private void clanlist(L2PcInstance activeChar, int index)
	{
		...
		final StringBuilder html = StringUtil.startAppend(2000, "<html><body><br><br><center>"
				...
				*/
				+ "<td width=610 height=30 align=left>" + "<a action=\"bypass _bbsclan_clanlist\"> &amp;$809; </a>"
				...
				*/
				+ "<a action=\"bypass _bbsclan_clanhome;", String.valueOf((activeChar.getClan() != null) ? activeChar.getClan().getClanId() : 0), "\">["+MessageTable.Messages[57].getMessage()+"]</a>&nbsp;&nbsp;"
				+ "</td>"
				+ "<td fixWIDTH=5></td>"
				+ "</tr>"
				...
				*/
				+ "<td FIXWIDTH=200 align=center>"+MessageTable.Messages[58].getMessage()+"</td>"
				+ "<td FIXWIDTH=200 align=center>"+MessageTable.Messages[59].getMessage()+"</td>"
				+ "<td FIXWIDTH=100 align=center>"+MessageTable.Messages[60].getMessage()+"</td>"
				+ "<td FIXWIDTH=100 align=center>"+MessageTable.Messages[61].getMessage()+"</td>"
		...
		if (cl != null)
		{
			...
			else
			{
				final String html = StringUtil.concat("<html><body><center><br><br>"
						...
						*/
						+ "<a action=\"bypass _bbshome\">"+MessageTable.Messages[53].getMessage()+"</a> &gt; <a action=\"bypass _bbsclan_clanlist\"> &amp;$809; </a>  &gt; <a action=\"bypass _bbsclan_clanhome;", String.valueOf(clanId), "\"> &amp;$802; </a>"
						+ "</td></tr></table>"
						...
						*/
						+ "<a action=\"bypass _bbsclan_clanhome;", String.valueOf(clanId), ";announce\">["+MessageTable.Messages[63].getMessage()+"]</a>&nbsp;&nbsp;<a action=\"bypass _bbsclan_clanhome;", String.valueOf(clanId), ";cbb\">["+MessageTable.Messages[64].getMessage()+"]</a>&nbsp;&nbsp;"
						+ "<a action=\"bypass _bbsclan_clanhome;", String.valueOf(clanId), ";cmail\">["+MessageTable.Messages[65].getMessage()+"]</a>&nbsp;&nbsp;"
						+ "<a action=\"bypass _bbsclan_clannotice_edit;", String.valueOf(clanId), ";cnotice\">["+MessageTable.Messages[66].getMessage()+"]</a>&nbsp;&nbsp;"
						+ "</td>"
						+ "<td fixWIDTH=5></td>"
						+ "</tr>"
						+ "<tr><td height=10></td></tr>"
						...
						*/
						+ "<td fixWIDTH=100 align=left>"+MessageTable.Messages[58].getMessage()+"</td>" + "<td fixWIDTH=195 align=left>", cl.getName(), "</td>" + "</tr>"
						+ "<tr><td height=7></td></tr>" + "<tr>" + "<td fixWIDTH=100 align=left>"+MessageTable.Messages[60].getMessage()+"</td>"
						...
						*/
						+ "<tr><td height=7></td></tr>" + "<tr>" + "<td fixWIDTH=100 align=left>"+MessageTable.Messages[61].getMessage()+"</td>"
						...
						*/
						+ "<tr><td height=7></td></tr>" + "<tr>" + "<td fixWIDTH=100 align=left>"+MessageTable.Messages[59].getMessage()+"</td>"
						...
						*/
						"<tr><td height=7></td></tr>" + "<tr>" + "<td fixWIDTH=100 align=left>"+MessageTable.Messages[67].getMessage()+"</td>"
