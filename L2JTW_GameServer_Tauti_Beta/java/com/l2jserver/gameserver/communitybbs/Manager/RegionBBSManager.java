...
public class RegionBBSManager extends BaseBBSManager {
	...
	private void showOldCommunityPI(L2PcInstance activeChar, String name) {
		...
		/*
		 * Move To MessageTable For L2JTW + "<table border=0><tr><td FIXWIDTH=15></td><td align=center>L2J Community Board<img src=\"sek.cbui355\" width=610 height=1></td></tr><tr><td FIXWIDTH=15></td><td>");
		 */
		...
		if (player != null) {
			/*
			 * Move To MessageTable For L2JTW String sex = "Male";
			 */
			String sex = MessageTable.Messages[77].getMessage();
			if (player.getAppearance().getSex()) {
				/*
				 * Move To MessageTable For L2JTW sex = "Female";
				 */
				sex = MessageTable.Messages[78].getMessage();
			}
			/*
			 * Move To MessageTable For L2JTW String levelApprox = "low";
			 */
			String levelApprox = MessageTable.Messages[79].getMessage();
			if (player.getLevel() >= 60) {
				/*
				 * Move To MessageTable For L2JTW levelApprox = "very high";
				 */
				levelApprox = MessageTable.Messages[80].getMessage();
			} else if (player.getLevel() >= 40) {
				/*
				 * Move To MessageTable For L2JTW levelApprox = "high";
				 */
				levelApprox = MessageTable.Messages[81].getMessage();
			} else if (player.getLevel() >= 20) {
				/*
				 * Move To MessageTable For L2JTW levelApprox = "medium";
				 */
			...
			/*
			 * Move To MessageTable For L2JTW + "<tr><td>Level: ", levelApprox, "</td></tr>" + "<tr><td><br></td></tr>");
			 */
			...
			if ((activeChar != null) && (activeChar.isGM() || (player.getObjectId() == activeChar.getObjectId()) || Config.SHOW_LEVEL_COMMUNITYBOARD)) {
				...
				/*
				 * Move To MessageTable For L2JTW StringUtil.append(htmlCode, "<tr><td>Level: ", String.valueOf(player.getLevel()), "</td></tr>" + "<tr><td>Experience: ", String.valueOf(player.getExp()), "/", String.valueOf(nextLevelExp), "</td></tr>" + "<tr><td>Experience needed for level up: ",
				 * String.valueOf(nextLevelExpNeeded), "</td></tr>"
				 */
			...
			/*
			 * Move To MessageTable For L2JTW StringUtil.append(htmlCode, "<tr><td>Uptime: ", String.valueOf(h), "h ", String.valueOf(m), "m ", String.valueOf(s), "s</td></tr>"
			 */
			...
			if (player.getClan() != null) {
				/*
				 * Move To MessageTable For L2JTW StringUtil.append(htmlCode, "<tr><td>Clan: ", player.getClan().getName(), "</td></tr>" + "<tr><td><br></td></tr>");
				 */
				StringUtil.append(htmlCode, "<tr><td>" + MessageTable.Messages[88].getMessage(), player.getClan().getName(), "</td></tr>" + "<tr><td><br></td></tr>");
			}
			
			/*
			 * Move To MessageTable For L2JTW StringUtil.append(htmlCode, "<tr><td><multiedit var=\"pm\" width=240 height=40><button value=\"Send PM\" action=\"Write Region PM ", player.getName(),
			 * " pm pm pm\" width=110 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr><tr><td><br><button value=\"Back\" action=\"bypass _bbsloc\" width=40 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr></table>" + "</td></tr></table>" +
			 * "</body></html>");
			 */
			...
			/*
			 * Move To MessageTable For L2JTW ShowBoard sb = new ShowBoard(StringUtil.concat("<html><body><br><br><center>No player with name ", name, "</center><br><br></body></html>"), "101");
			 */
	...
	public void parsewrite(String ar1, String ar2, String ar3, String ar4, String ar5, L2PcInstance activeChar) {
		...
		if (ar1.equals("PM")) {
			...
			try {
				...
				if (receiver == null) {
					/*
					 * Move To MessageTable For L2JTW StringUtil.append(htmlCode, "Player not found!<br><button value=\"Back\" action=\"bypass _bbsloc;playerinfo;", ar2, "\" width=40 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">"
					 */
				...
				if (Config.JAIL_DISABLE_CHAT && receiver.isInJail()) {
					/*
					 * Move To MessageTable For L2JTW activeChar.sendMessage("Player is in jail.");
					 */
				...
				if (receiver.isChatBanned()) {
					/*
					 * Move To MessageTable For L2JTW activeChar.sendMessage("Player is chat banned.");
					 */
				...
				if (activeChar.isInJail() && Config.JAIL_DISABLE_CHAT) {
					/*
					 * Move To MessageTable For L2JTW activeChar.sendMessage("You can not chat while in jail.");
					 */
				...
				if (activeChar.isChatBanned()) {
					/*
					 * Move To MessageTable For L2JTW activeChar.sendMessage("You are banned from using chat");
					 */
				...
				if (!receiver.isSilenceMode(activeChar.getObjectId()) && !BlockList.isBlocked(receiver, activeChar)) {
					...
					/*
					 * Move To MessageTable For L2JTW StringUtil.append(htmlCode, "Message Sent<br><button value=\"Back\" action=\"bypass _bbsloc;playerinfo;", receiver.getName(), "\" width=40 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">"
					 */
			...
			/*
			 * Move To MessageTable For L2JTW ShowBoard sb = new ShowBoard(StringUtil.concat("<html><body><br><br><center>the command: ", ar1, " is not implemented yet</center><br><br></body></html>"), "101");
			 */
	...
	private void writeCommunityPages() {
		...
		for (int page : _onlinePlayers.keySet()) {
			...
			/*
			 * Move To MessageTable For L2JTW StringUtil.append(htmlCode, "<html><body><br>" + "<table>" + trOpen + "<td align=left valign=top>Server Restarted: ", String.valueOf(GameServer.dateTimeServerStarted.getTime()), tdClose + trClose + "</table>" + "<table>" + trOpen + tdOpen + "XP Rate: x",
			 * String.valueOf(Config.RATE_XP), tdClose + colSpacer + tdOpen + "Party XP Rate: x", String.valueOf(Config.RATE_XP * Config.RATE_PARTY_XP), tdClose + colSpacer + tdOpen + "XP Exponent: ", String.valueOf(Config.ALT_GAME_EXPONENT_XP), tdClose + trClose + trOpen + tdOpen + "SP Rate: x",
			 * String.valueOf(Config.RATE_SP), tdClose + colSpacer + tdOpen + "Party SP Rate: x", String.valueOf(Config.RATE_SP Config.RATE_PARTY_SP), tdClose + colSpacer + tdOpen + "SP Exponent: ", String.valueOf(Config.ALT_GAME_EXPONENT_SP), tdClose + trClose + trOpen + tdOpen + "Drop Rate: ",
			 * String.valueOf(Config.RATE_DROP_ITEMS), tdClose + colSpacer + tdOpen + "Spoil Rate: ", String.valueOf(Config.RATE_DROP_SPOIL), tdClose + colSpacer + tdOpen + "Adena Rate: ", String.valueOf(Config.RATE_DROP_ITEMS_ID.get(PcInventory.ADENA_ID)), tdClose
			 */
			StringUtil.append(htmlCode, "<html><body><br>" + "<table>" + trOpen + "<td align=left width=\"600\" valign=top>" + MessageTable.Messages[104].getMessage(), String.valueOf(GameServer.dateTimeServerStarted.getTime()), tdClose + trClose + "</table>" + "<table>" + trOpen + tdOpen + MessageTable.Messages[105].getMessage(), String.valueOf(Config.RATE_XP), tdClose + colSpacer + tdOpen + MessageTable.Messages[106].getMessage(), String.valueOf(Config.RATE_XP * Config.RATE_PARTY_XP), tdClose + colSpacer + tdOpen + MessageTable.Messages[107].getMessage(), String.valueOf(Config.ALT_GAME_EXPONENT_XP), tdClose + trClose + trOpen + tdOpen + MessageTable.Messages[108].getMessage(), String.valueOf(Config.RATE_SP), tdClose + colSpacer + tdOpen + MessageTable.Messages[109].getMessage(), String.valueOf(Config.RATE_SP * Config.RATE_PARTY_SP), tdClose + colSpacer + tdOpen + MessageTable.Messages[110].getMessage(), String.valueOf(Config.ALT_GAME_EXPONENT_SP), tdClose + trClose + trOpen + tdOpen + MessageTable.Messages[111].getMessage(), String.valueOf(Config.RATE_DROP_ITEMS), tdClose + colSpacer + tdOpen + MessageTable.Messages[112].getMessage(), String.valueOf(Config.RATE_DROP_SPOIL), tdClose + colSpacer + tdOpen + MessageTable.Messages[113].getMessage(), String.valueOf(Config.RATE_DROP_ITEMS_ID.get(PcInventory.ADENA_ID)), tdClose + trClose + "</table>" + "<table>" + trOpen + "<td><img src=\"sek.cbui355\" width=600 height=1><br></td>" + trClose
			/*
			 * Move To MessageTable For L2JTW + trOpen + tdOpen, String.valueOf(L2World.getInstance().getAllVisibleObjectsCount()), " Object count</td>" + trClose + trOpen + tdOpen, String.valueOf(getOnlineCount("gm")), " Player(s) Online</td>" + trClose + "</table>");
			 */
			+ trOpen + tdOpen, String.valueOf(L2World.getInstance().getAllVisibleObjectsCount()), MessageTable.Messages[114].getMessage() + "</td>" + trClose + trOpen + tdOpen, String.valueOf(getOnlineCount("gm")), MessageTable.Messages[115].getMessage() + "</td>" + trClose + "</table>");
			...
			if (getOnlineCount("gm") > Config.NAME_PAGE_SIZE_COMMUNITYBOARD) {
				...
				if (page == 1) {
					/*
					 * Move To MessageTable For L2JTW htmlCode.append("<td align=right width=190><button value=\"Prev\" width=50 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
					 */
					...
					/*
					 * Move To MessageTable For L2JTW StringUtil.append(htmlCode, "<td align=right width=190><button value=\"Prev\" action=\"bypass _bbsloc;page;", String.valueOf(page - 1), "\" width=50 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
					 */
				...
				/*
				 * Move To MessageTable For L2JTW StringUtil.append(htmlCode, "<td FIXWIDTH=10></td>" + "<td align=center valign=top width=200>Displaying ", String.valueOf(((page - 1) * Config.NAME_PAGE_SIZE_COMMUNITYBOARD) + 1), " - ", String.valueOf(((page - 1) *
				 * Config.NAME_PAGE_SIZE_COMMUNITYBOARD) + getOnlinePlayers(page).size()), " player(s)</td>" + "<td FIXWIDTH=10></td>");
				 */
				...
				if (getOnlineCount("gm") <= (page * Config.NAME_PAGE_SIZE_COMMUNITYBOARD)) {
					/*
					 * Move To MessageTable For L2JTW htmlCode.append("<td width=190><button value=\"Next\" width=50 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
					 */
					...
					/*
					 * Move To MessageTable For L2JTW StringUtil.append(htmlCode, "<td width=190><button value=\"Next\" action=\"bypass _bbsloc;page;", String.valueOf(page + 1), "\" width=50 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
					 */
			...
			htmlCode.setLength(0);
			/*
			 * Move To MessageTable For L2JTW StringUtil.append(htmlCode, "<html><body><br>" + "<table>" + trOpen + "<td align=left valign=top>Server Restarted: ", String.valueOf(GameServer.dateTimeServerStarted.getTime()), tdClose + trClose + "</table>" + "<table>" + trOpen + tdOpen + "XP Rate: ",
			 * String.valueOf(Config.RATE_XP), tdClose + colSpacer + tdOpen + "Party XP Rate: ", String.valueOf(Config.RATE_PARTY_XP), tdClose + colSpacer + tdOpen + "XP Exponent: ", String.valueOf(Config.ALT_GAME_EXPONENT_XP), tdClose + trClose + trOpen + tdOpen + "SP Rate: ",
			 * String.valueOf(Config.RATE_SP), tdClose + colSpacer + tdOpen + "Party SP Rate: ", String.valueOf(Config.RATE_PARTY_SP), tdClose + colSpacer + tdOpen + "SP Exponent: ", String.valueOf(Config.ALT_GAME_EXPONENT_SP), tdClose + trClose + trOpen + tdOpen + "Drop Rate: ",
			 * String.valueOf(Config.RATE_DROP_ITEMS), tdClose + colSpacer + tdOpen + "Spoil Rate: ", String.valueOf(Config.RATE_DROP_SPOIL), tdClose + colSpacer + tdOpen + "Adena Rate: ", String.valueOf(Config.RATE_DROP_ITEMS_ID.get(PcInventory.ADENA_ID)), tdClose
			 */
			...
			/*
			 * Move To MessageTable For L2JTW + trOpen + tdOpen, String.valueOf(getOnlineCount("pl")), " Player(s) Online</td>" + trClose + "</table>");
			 */
