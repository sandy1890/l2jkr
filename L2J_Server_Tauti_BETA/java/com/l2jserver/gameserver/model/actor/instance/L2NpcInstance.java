...
public class L2NpcInstance extends L2Npc {
	...
	public static void showSkillList(L2PcInstance player, L2Npc npc, ClassId classId) {
		...
		if (((L2NpcInstance) npc).getClassesToTeach().isEmpty()) {
			...
			/*
			 * Move To MessageTable For L2JTW "I cannot teach you. My class list is empty.<br> Ask admin to fix it. Need add my npcid and classes to skill_learn.sql.<br>NpcId:",
			 */
			MessageTable.Messages[679].getMessage() + "<br>" + MessageTable.Messages[680].getMessage() + "<br>" + MessageTable.Messages[681].getMessage(), String.valueOf(npcId),
			/*
			 * Move To MessageTable For L2JTW ", Your classId:",
			 */
			MessageTable.Messages[682].getMessage(), String.valueOf(player.getClassId().getId()), "<br>" + "</body></html>");
			html.setHtml(sb);
