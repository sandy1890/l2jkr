...
public final class RequestCrystallizeItem extends L2GameClientPacket {
	...
	protected void runImpl() {
		...
		if (!getClient().getFloodProtectors().getTransaction().tryPerformAction("crystallize")) {
			/*
			 * Move To MessageTable For L2JTW activeChar.sendMessage("You are crystallizing too fast.");
			 */
		...
		if (/*
			 ...
			 */(itemToRemove.getItem().getCrystalCount() < 0) || (itemToRemove.getItem().getCrystalType() == L2Item.CRYSTAL_NONE)) // rocknow-temp fix
		{
