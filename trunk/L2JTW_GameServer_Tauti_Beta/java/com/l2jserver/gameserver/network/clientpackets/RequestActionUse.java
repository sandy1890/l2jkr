...
public final class RequestActionUse extends L2GameClientPacket {
	...
	protected void runImpl() {
		...
		switch (_actionId) {
			...
			case 65: // Bot Report Button
				/*
				 * Move To MessageTable For L2JTW activeChar.sendMessage("Action not handled yet.");
				 */
			...
			// rocknow-God-Start
			case 78:
				useCoupleSocial(Rnd.get(20, 22)); // rocknow-God-Test Only
			break;
			case 79:
				useCoupleSocial(Rnd.get(23, 25)); // rocknow-God-Test Only
			break;
			case 80:
				useCoupleSocial(Rnd.get(26, 27)); // rocknow-God-Test Only
			break;
			case 81:
				tryBroadcastSocial(30); // rocknow-God-Test Only
			break;
			case 82:
				tryBroadcastSocial(31); // rocknow-God-Test Only
			break;
			case 83:
				useCoupleSocial(32); // rocknow-God-Test Only
			break;
			case 84:
				useCoupleSocial(33); // rocknow-God-Test Only
			break;
			case 85:
				useCoupleSocial(34); // rocknow-God-Test Only
			break;
			case 87:
	...
	private void useSkill(int skillId, L2Object target) {
		...
		if (activeChar.getPrivateStoreType() != 0) {
			/*
			 * Move To MessageTable For L2JTW activeChar.sendMessage("You cannot use a skill while operating a private store.");
			 */
	...
	private void useCoupleSocial(int id) {
		...
		if (activeChar.getObjectId() == player.getObjectId()) {
			/*
			 * Move To MessageTable For L2JTW activeChar.sendMessage("You cannot request a couple action yourself.");
			 */
		...
		if (activeChar.isCastingNow() || activeChar.isCastingSimultaneouslyNow()) {
			/*
			 * Move To MessageTable For L2JTW activeChar.sendMessage("You cannot request a couple action while casting.");
			 */
