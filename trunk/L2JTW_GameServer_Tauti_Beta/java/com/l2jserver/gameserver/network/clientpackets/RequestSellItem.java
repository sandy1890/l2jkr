...
/**
 * packet type id 0x1e sample 1e 00 00 00 00 // list id 02 00 00 00 // number of items 71 72 00 10 // object id ea 05 00 00 // item id 01 00 00 00 // item count 76 4b 00 10 // object id 2e 0a 00 00 // item id 01 00 00 00 // item count format: cdd (ddd) RequestSellItem client packet class.
 */
public final class RequestSellItem extends L2GameClientPacket {
	...
	protected void processSell() {
		...
		if (!getClient().getFloodProtectors().getTransaction().tryPerformAction("buy")) {
			/*
			 * Move To MessageTable For L2JTW player.sendMessage("You are buying too fast.");
			 */
