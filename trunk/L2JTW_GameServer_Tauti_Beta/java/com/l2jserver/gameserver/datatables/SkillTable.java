...
import com.l2jserver.gameserver.model.L2SkillLearn; //rocknow-God-Awaking
import com.l2jserver.gameserver.model.actor.instance.L2PcInstance; //rocknow-God-Awaking
import com.l2jserver.gameserver.model.base.ClassId; //rocknow-God-Awaking
...
public class SkillTable
{
	...
	/*private*/ final TIntObjectHashMap<L2Skill> _skills; // By ShanSoft
	...
	public final L2Skill getInfo(final int skillId, final int level)
	{
		...
		_log.warning(MessageTable.Messages[2000].getExtra(1) + skillId + MessageTable.Messages[2000].getExtra(2) + level + MessageTable.Messages[2000].getExtra(3));
		return null;
	}
