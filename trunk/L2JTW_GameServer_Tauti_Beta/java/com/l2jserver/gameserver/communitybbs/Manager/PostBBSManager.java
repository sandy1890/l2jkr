...
public class PostBBSManager extends BaseBBSManager
{
	...
	private void showHtmlEditPost(Topic topic, L2PcInstance activeChar, Forum forum, Post p)
	{
		final String html = StringUtil.concat("<html>" + "<body><br><br>"
				...
				*/
				+ "<a action=\"bypass _bbshome\">"+MessageTable.Messages[70].getMessage()+"</a>&nbsp;>&nbsp;<a action=\"bypass _bbsmemo\">", forum.getName(), MessageTable.Messages[71].getMessage()+"</a>"
				+ "</td></tr>"
				+ "</table>"
	...
	private void showMemoPost(Topic topic, L2PcInstance activeChar, Forum forum)
	{
		...
		final String html = StringUtil.concat("<html><body><br><br>"
				...
				*/
				+ "<a action=\"bypass _bbshome\">"+MessageTable.Messages[70].getMessage()+"</a>&nbsp;>&nbsp;<a action=\"bypass _bbsmemo\">"+MessageTable.Messages[72].getMessage()+"</a>" + "</td></tr>"
