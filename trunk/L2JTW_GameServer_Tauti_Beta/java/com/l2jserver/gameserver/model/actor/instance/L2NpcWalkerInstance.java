...
public class L2NpcWalkerInstance extends L2Npc
{
	...
	public void broadcastChat(String chat, NpcStringId npcString)
	{
		...
		int NPCID = getNpcId();
		if (NPCID > 59999 && NPCID < 60005)
			NPCID = 33217;
		else if (NPCID > 60004 && NPCID < 60011)
			NPCID = 33224;
		else if (NPCID > 60017 && NPCID < 60021)
			NPCID = 33105;
		else if (NPCID > 60020 && NPCID < 60026)
			NPCID = 33106;
		//rocknow-God-Test Only-End
		if (npcString == null)
			cs = new NpcSay(getObjectId(), Say2.NPC_SAY, NPCID, chat); //rocknow-God
		else
			cs = new NpcSay(getObjectId(), Say2.NPC_SAY, NPCID, npcString); //rocknow-God
