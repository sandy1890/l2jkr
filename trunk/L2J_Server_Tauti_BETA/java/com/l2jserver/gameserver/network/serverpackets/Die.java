...
public class Die extends L2GameServerPacket {
	...
	protected final void writeImpl() {
		...
		if (_canTeleport && _clan != null && ZoneManager.getInstance().getZone(_activeChar, L2RespawnZone.class) == null) {
			...
			writeD(_sweepable ? 0x01 : 0x00); // sweepable (blue glow)
			/*
			 * l2jtw start writeD(_access.allowFixedRes() ? 0x01: 0x00); // 6d 04 00 00 00 - to FIXED
			 */
		...
		// TODO: protocol 152
		/*
		 * writeC(0); //show die animation writeD(0); //agathion ress button writeD(0); //additional free space
		 */
	}
