...
public final class IllegalPlayerAction implements Runnable {
	...
	public IllegalPlayerAction(L2PcInstance actor, String message, int punishment) {
		...
		switch (punishment) {
			case PUNISH_KICK:
				/*
				 * Move To MessageTable For L2JTW _actor.sendMessage("You will be kicked for illegal action, GM informed.");
				 */
			...
			case PUNISH_KICKBAN:
				...
				/*
				 * Move To MessageTable For L2JTW _actor.sendMessage("You are banned for illegal action, GM informed.");
				 */
				_actor.sendMessage(160);
			break;
			case PUNISH_JAIL:
				/*
				 * Move To MessageTable For L2JTW _actor.sendMessage("Illegal action performed!"); _actor.sendMessage("You will be teleported to GM Consultation Service area and jailed.");
				 */
