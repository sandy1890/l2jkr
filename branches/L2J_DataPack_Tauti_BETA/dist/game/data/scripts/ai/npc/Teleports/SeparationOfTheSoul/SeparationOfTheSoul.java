 ...
 */
package ai.npc.Teleports.SeparationOfTheSoul;
...
/**
 * @author pmq update to H5
 */
public class SeparationOfTheSoul extends AbstractNpcAI {
	 ...
	 * @param descr
	 */
	public SeparationOfTheSoul(String name, String descr) {
		super(name, descr);
	...
	public static void main(String[] args) {
		new SeparationOfTheSoul(SeparationOfTheSoul.class.getSimpleName(), "ai/npc/Teleports/");
	}
