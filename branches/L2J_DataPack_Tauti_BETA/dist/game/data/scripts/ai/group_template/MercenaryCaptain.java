...
/**
 * MercenaryCaptain
 * @author mrTJO Mercenary Broadcast in the city a random message every hour at hh:55 (Real time) *
 */
...
public class MercenaryCaptain extends Quest {
	...
	class BroadcastToZone implements Runnable {
		...
		private final Logger _log = Logger.getLogger(BroadcastToZone.class.getName());
