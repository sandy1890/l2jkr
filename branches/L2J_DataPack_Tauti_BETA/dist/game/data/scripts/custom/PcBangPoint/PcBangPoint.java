...
public class PcBangPoint extends Quest {
	...
	static {
		...
		POINTSSKILL.put("S4391", new int[] { 4391, 2, 300 }); // 윈드워크 Lv2
		POINTSSKILL.put("S4392", new int[] { 4392, 3, 200 }); // 실드 Lv3
		POINTSSKILL.put("S4393", new int[] { 4393, 3, 400 }); // 마이트 Lv3
		POINTSSKILL.put("S4394", new int[] { 4394, 4, 400 }); // 블레스 더 바디 Lv4
		POINTSSKILL.put("S4395", new int[] { 4395, 4, 400 }); // 블레스 더 소울 Lv4
		POINTSSKILL.put("S4396", new int[] { 4396, 2, 400 }); // 매직베리어 Lv2
		POINTSSKILL.put("S4397", new int[] { 4397, 2, 500 }); // 버서커 스피릿 Lv2
		POINTSSKILL.put("S4398", new int[] { 4398, 3, 200 }); // 블레스 실드 Lv3
		POINTSSKILL.put("S4399", new int[] { 4399, 3, 400 }); // 뱀피릭 레이지 Lv3
		POINTSSKILL.put("S4440", new int[] { 4400, 3, 950 }); // 아큐멘 Lv3
		POINTSSKILL.put("S4401", new int[] { 4401, 3, 400 }); // 엠파워 Lv3
		POINTSSKILL.put("S4402", new int[] { 4402, 2, 950 }); // 헤이스트 Lv2
		POINTSSKILL.put("S4403", new int[] { 4403, 3, 400 }); // 가이던스 Lv3
		POINTSSKILL.put("S4404", new int[] { 4404, 3, 800 }); // 포커스 Lv3
		POINTSSKILL.put("S4405", new int[] { 4405, 3, 950 }); // 데스 위스퍼 Lv3
		POINTSSKILL.put("S4406", new int[] { 4406, 3, 400 }); // 어질리티 Lv3
		
		// Pet Skill ID LV QTY Points
		PETSKILL.put("P4391", new int[] { 4391, 2, 300 }); // 윈드워크 Lv2
		PETSKILL.put("P4392", new int[] { 4392, 2, 150 }); // 실드 Lv2
		PETSKILL.put("P4393", new int[] { 4393, 2, 300 }); // 마이트 Lv2
		PETSKILL.put("P4394", new int[] { 4394, 3, 300 }); // 블레스 더 바디 Lv3
		PETSKILL.put("P4395", new int[] { 4395, 3, 300 }); // 블레스 더 소울 Lv3
		PETSKILL.put("P4396", new int[] { 4396, 1, 300 }); // 매직베리어 Lv1
		PETSKILL.put("P4397", new int[] { 4397, 1, 300 }); // 버서커 스피릿 Lv1
		PETSKILL.put("P4398", new int[] { 4398, 2, 150 }); // 블레스 실드 Lv2
		PETSKILL.put("P4399", new int[] { 4399, 2, 300 }); // 뱀피릭 레이지 Lv2
		PETSKILL.put("P4440", new int[] { 4400, 2, 600 }); // 아큐멘 Lv2
		PETSKILL.put("P4401", new int[] { 4401, 2, 300 }); // 엠파워 Lv2
		PETSKILL.put("P4402", new int[] { 4402, 1, 400 }); // 헤이스트 Lv1
		PETSKILL.put("P4403", new int[] { 4403, 2, 300 }); // 가이던스 Lv2
		PETSKILL.put("P4404", new int[] { 4404, 2, 650 }); // 포커스 Lv2
		PETSKILL.put("P4405", new int[] { 4405, 2, 800 }); // 데스 위스퍼 Lv2
		PETSKILL.put("P4406", new int[] { 4406, 2, 300 }); // 어질리티 Lv2
		
		// 텔레포터 x y z QTY Points
		// 말하는 섬 마을 텔레포터
