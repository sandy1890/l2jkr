...
public class PailakaInjuredDragon extends Quest {
	...
	public final String onAdvEvent(String event, L2Npc npc, L2PcInstance player) {
		...
		} else if (event.equalsIgnoreCase("32499-02.htm")) // Shouldn't be 32499-04.htm ???
		{
			...
			/*
			 * InstanceWorld world = InstanceManager.getInstance().getWorld(npc.getInstanceId()); for(int objId : world.allowed) { L2PcInstance pl = L2World.getInstance().getPlayer(objId); if (pl != null) pl.showQuestMovie(?); }
			 */
