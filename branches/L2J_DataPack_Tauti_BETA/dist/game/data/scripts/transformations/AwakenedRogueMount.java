...
public class AwakenedRogueMount extends L2Transformation
{
	...
	{
		if ((getPlayer().getTransformationId() != 131) || getPlayer().isCursedWeaponEquipped())
		{
			return;
		}
	...
	{
		TransformationManager.getInstance().registerTransformation(new AwakenedRogueMount());
	}
}
