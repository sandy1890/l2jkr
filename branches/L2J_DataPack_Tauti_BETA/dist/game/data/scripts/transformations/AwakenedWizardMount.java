...
public class AwakenedWizardMount extends L2Transformation {
	...
	public void onTransform() {
		if ((getPlayer().getTransformationId() != 133) || getPlayer().isCursedWeaponEquipped()) {
			return;
		}
	...
	public static void main(String[] args) {
		TransformationManager.getInstance().registerTransformation(new AwakenedWizardMount());
	}
}
