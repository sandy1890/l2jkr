...
public class GuardsoftheDawn extends L2Transformation
{
	...
	public void transformedSkills()
	{
		...
		// Transform Dispel
		// getPlayer().addSkill(SkillTable.getInstance().getInfo(619, 1), false); //Update by pmq
		// Guard Ambush
	...
	public void removeSkills()
	{
		...
		// Transform Dispel
		// getPlayer().removeSkill(SkillTable.getInstance().getInfo(619, 1), false); //Update by pmq
		// Guard's Ambush
