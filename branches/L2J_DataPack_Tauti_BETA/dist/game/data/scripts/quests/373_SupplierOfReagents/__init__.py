...
#Quest info
QUEST_NUMBER,QUEST_NAME,QUEST_DESCRIPTION = 373,"SupplierOfReagents","試劑的供應計畫"
qn = "373_SupplierOfReagents"

#Variables
#itemId:[icon,name,description]
ITEMS={
6011:["etc_reagent_red_i00","亞龍的血",""],
6012:["etc_inf_ore_high_i00","熔岩石",""],
6013:["etc_broken_crystal_silver_i00","月石破片",""],
6014:["etc_piece_bone_black_i00","腐爛的碎片",""],
6015:["etc_reagent_green_i00","惡魔的血",""],
6016:["etc_inf_ore_least_i00","因分尼恩原石","最低等級反應物"],
6017:["etc_ginseng_red_i00","血的根",""],
6018:["etc_powder_gray_i00","火山灰",""],
6019:["etc_reagent_silver_i00","汞",""],
6020:["etc_powder_orange_i00","硫磺",""],
6021:["etc_dragons_blood_i05","龍的原生質","最低等級反應物"],
6022:["etc_powder_red_i00","岩漿粉末",""],
6023:["etc_powder_white_i00","月亮粉末","最低等級反應物"],
6024:["etc_potion_purpel_i00","腐屍的原生質","最低等級反應物"],
6025:["etc_potion_green_i00","惡魔的原生質","最低等級反應物"],
6026:["etc_powder_black_i00","地獄粉末",""], 
6027:["etc_dragon_blood_i00","龍的精華","最高等級反應物"],
6028:["etc_dragons_blood_i00","烈火的精華","最高等級反應物"],
6029:["etc_mithril_ore_i00","路娜根特","最高等級反應物"],
6030:["etc_dragons_blood_i02","午夜的油","最高等級反應物"],
6031:["etc_dragons_blood_i05","惡魔的精華","最高等級反應物"],
6032:["etc_dragons_blood_i04","深淵的油","最高等級反應物"],
6033:["etc_luxury_wine_b_i00","地獄業火的油","最高等級反應物"],
6034:["etc_luxury_wine_c_i00","夢魘的油","最高等級反應物"],
6320:["etc_broken_crystal_silver_i00","純銀",""],
6321:["etc_broken_crystal_gold_i00","真金",""],
}
#Quest items
...
def render_urn(st, page) :
    ...
    if page == "Start" :
       html = "<html><body>混合材料用的缸:<br><table border=0 width=300><tr><tr><td width=50%><a action=\"bypass -h Quest 373_SupplierOfReagents U_M_MACT\">放入/取出混合石</a></td><td></td></tr><tr><td><a action=\"bypass -h Quest 373_SupplierOfReagents U_I_IACT\">選擇主材料</a></td><td>(目前: INGR)</td></tr><tr><td><a action=\"bypass -h Quest 373_SupplierOfReagents U_C_CACT\">選擇催化劑</a></td><td>(目前: CATA)</td></tr><tr><td><a action=\"bypass -h Quest 373_SupplierOfReagents 31149-5.htm\">選擇溫度</a></td><td>(目前: 溫度)</td></tr><tr><td><a action=\"bypass -h Quest 373_SupplierOfReagents 31149-6.htm\">混合</a></td><td></td></tr></table></body></html>"
       ...
       html = "<html><body>選擇:<table border=0>"
       amt = 0
       for i in MATS :
       ...
       html += "</table><center><a action=\"bypass -h Quest 373_SupplierOfReagents urn\">返回</a></center></body></html>"
    return html
