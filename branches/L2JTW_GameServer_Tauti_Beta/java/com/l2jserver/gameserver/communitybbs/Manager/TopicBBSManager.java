...
public class TopicBBSManager extends BaseBBSManager
{
	...
	private void showMemoNewTopics(Forum forum, L2PcInstance activeChar)
	{
		final String html = StringUtil.concat("<html>"
				...
				*/
				+ "<a action=\"bypass _bbshome\">"+MessageTable.Messages[124].getMessage()+"</a>&nbsp;>&nbsp;<a action=\"bypass _bbsmemo\">"+MessageTable.Messages[125].getMessage()+"</a>"
				+ "</td></tr>"
				+ "</table>"
	...
	private void showMemoTopics(Forum forum, L2PcInstance activeChar, int index)
	{
		...
		final StringBuilder html = StringUtil.startAppend(2000, "<html><body><br><br>"
				...
				*/
				+ "<a action=\"bypass _bbshome\">"+MessageTable.Messages[124].getMessage()+"</a>&nbsp;>&nbsp;<a action=\"bypass _bbsmemo\">"+MessageTable.Messages[125].getMessage()+"</a>" + "</td></tr>"
