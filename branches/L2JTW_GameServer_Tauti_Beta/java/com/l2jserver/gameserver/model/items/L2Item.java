...
public abstract class L2Item
{
	...
	public static final int MATERIAL_ORICHALCUM = 0x21; //rocknow-God-Awaking
	...
	public static final int SS_NG = 0x00; // ??
	public static final int SS_D = 0x01; // ??
	public static final int SS_C = 0x02; // ??
	public static final int SS_B = 0x03; // ??
	public static final int SS_A = 0x04; // ??
	public static final int SS_S = 0x05; // ??
	public static final int SS_R = 0x06; // ??
	//rocknow-God-End
	private static final int[] crystalItemId =
	{
		0, 1458, 1459, 1460, 1461, 1462, 1462, 1462, 17371, 17371, 17371 //rocknow-God
	};
	private static final int[] crystalEnchantBonusArmor =
	{
		0, 11, 6, 11, 19, 25, 25, 25, 25, 25, 25 //rocknow-God
	};
	private static final int[] crystalEnchantBonusWeapon =
	{
		0, 90, 45, 67, 144, 250, 250, 250, 250, 250, 250 //rocknow-God
	};
	
	private final int _itemId;
	private final int _displayId;
	private /* final */ String _name; //Update by rocknow
	...
	//rocknow-God-Start
	public final int getItemGradeRPlus()
	{
		switch (getItemGrade())
		{
			case SS_NG:
