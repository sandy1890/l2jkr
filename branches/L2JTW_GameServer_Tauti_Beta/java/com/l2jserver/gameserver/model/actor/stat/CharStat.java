...
public class CharStat
{
	...
	public final int getCON()
	{
		...
		*/
		return (int) calcStat(Stats.STAT_CON, (_activeChar instanceof L2PcInstance ? L2PcInstance.getTemplateForStat((L2PcInstance) _activeChar) : _activeChar.getTemplate()).getBaseCON(), null, null);
		// l2jtw end
	}
	...
	public final int getDEX()
	{
		 ...
		 */
		return (int) calcStat(Stats.STAT_DEX, (_activeChar instanceof L2PcInstance ? L2PcInstance.getTemplateForStat((L2PcInstance) _activeChar) : _activeChar.getTemplate()).getBaseDEX(), null, null);
		// l2jtw end
	}
	...
	public int getINT()
	{
		 ...
		 */
		return (int) calcStat(Stats.STAT_INT, (_activeChar instanceof L2PcInstance ? L2PcInstance.getTemplateForStat((L2PcInstance) _activeChar) : _activeChar.getTemplate()).getBaseINT(), null, null);
		// l2jtw end
	}
	...
	public final int getMEN()
	{
		 ...
		 */
		return (int) calcStat(Stats.STAT_MEN, (_activeChar instanceof L2PcInstance ? L2PcInstance.getTemplateForStat((L2PcInstance) _activeChar) : _activeChar.getTemplate()).getBaseMEN(), null, null);
		// l2jtw end
	}
	...
	public final int getSTR()
	{
		 ...
		 */
		return (int) calcStat(Stats.STAT_STR, (_activeChar instanceof L2PcInstance ? L2PcInstance.getTemplateForStat((L2PcInstance) _activeChar) : _activeChar.getTemplate()).getBaseSTR(), null, null);
		// l2jtw end
	}
	...
	public final int getWIT()
	{
		 ...
		 */
		return (int) calcStat(Stats.STAT_WIT, (_activeChar instanceof L2PcInstance ? L2PcInstance.getTemplateForStat((L2PcInstance) _activeChar) : _activeChar.getTemplate()).getBaseWIT(), null, null);
		// l2jtw end
	}
