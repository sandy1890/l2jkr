...
public class JumpManager
{
	...
	private TIntObjectHashMap<List<JumpNode>> _routes = new TIntObjectHashMap<List<JumpNode>>();
	...
	public void StartJump(L2PcInstance player)
	{
		...
		switch (_id)
		{
			case 910: _tracId = 1; break;	// Talking Island Village
		}
	...
	public void NextJump(L2PcInstance player, int nextId)
	{
		...
		// l2jtw add start
		if (nextId >= getRouteForId(_tracId).size()) return;
		// l2jtw end
