...
public class AwakingManager {
	...
	public void load() {
		...
		//@formatter:off
		/**
		 * 139 H_PhoenixKnight, H_HellKnight, E_EvaTemplar, DE_ShillienTemplar 140 H_Duelist, H_Dreadnought, O_Titan, O_GrandKhauatari, D_Maestro, K_Male_Doombringer
		 * 141 H_Adventurer, E_WindRider, DE_GhostHunter, D_FortuneSeeker, 142 H_Sagittarius, E_MoonlightSentinel, DE_GhostSentinel, K_Female_Trickster
		 * 143 H_Archmage, H_Soultaker, E_MysticMuse, DE_StormScreamer, K_Male_Soulhound, K_Female_Soulhound
		 * 144 H_Hierophant, E_SwordMuse, DE_SpectralDancer, O_Dominator, O_Doomcryer, K_Judicator 145 H_ArcanaLord, E_ElementalMaster, DE_SpectralMaster
	...
	public void AwakingRemoveSkills(L2PcInstance player) {
		for (int i : autoRemoveSkills) {
			...
			if (level > 0) {
				...
				_log.info(getClass().getSimpleName() + ":" + player.getName() + ", 스킬 제거:" + skill.getName() + " " + skill.getId());
