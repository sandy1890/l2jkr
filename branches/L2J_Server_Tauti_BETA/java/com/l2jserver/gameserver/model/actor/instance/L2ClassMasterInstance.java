...
public final class L2ClassMasterInstance extends L2MerchantInstance {
			...
			switch (jobLevel) {
				case 0:
					if (Config.CLASS_MASTER_SETTINGS.isAllowed(1)) {
						/*
						 * Move To MessageTable For L2JTW sb.append("Come back here when you reached level 20 to change your class.<br>");
						 */
						sb.append(MessageTable.Messages[617].getMessage());
					} else if (Config.CLASS_MASTER_SETTINGS.isAllowed(2)) {
						/*
						 * Move To MessageTable For L2JTW sb.append("Come back after your first occupation change.<br>");
						 */
						sb.append(MessageTable.Messages[618].getMessage());
					} else if (Config.CLASS_MASTER_SETTINGS.isAllowed(3)) {
						/*
						 * Move To MessageTable For L2JTW sb.append("Come back after your second occupation change.<br>");
						 */
						sb.append(MessageTable.Messages[619].getMessage());
					} else {
						/*
						 * Move To MessageTable For L2JTW sb.append("I can't change your occupation.<br>");
						 */
				...
				case 1:
					if (Config.CLASS_MASTER_SETTINGS.isAllowed(2)) {
						/*
						 * Move To MessageTable For L2JTW sb.append("Come back here when you reached level 40 to change your class.<br>");
						 */
				...
				case 2:
					if (Config.CLASS_MASTER_SETTINGS.isAllowed(3)) {
						/*
						 * Move To MessageTable For L2JTW sb.append("Come back here when you reached level 76 to change your class.<br>");
						 */
				...
				case 3:
					/*
					 * Move To MessageTable For L2JTW sb.append("There is no class change available for you anymore.<br>");
					 */
	...
	private static String getRequiredItems(int level) {
		if ((Config.CLASS_MASTER_SETTINGS.getRequireItems(level) == null) || Config.CLASS_MASTER_SETTINGS.getRequireItems(level).isEmpty()) {
			/*
			 * Move To MessageTable For L2JTW return "<tr><td>none</td></tr>";
			 */
