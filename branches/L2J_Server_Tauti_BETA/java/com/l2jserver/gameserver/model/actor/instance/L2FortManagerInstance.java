					...
					if (val.equalsIgnoreCase("recovery")) {
						if (st.countTokens() >= 1) {
							if (getFort().getOwnerClan() == null) {
								/*
								 * Move To MessageTable For L2JTW player.sendMessage("This fortress have no owner, you cannot change configuration");
								 */
							...
							if (val.equalsIgnoreCase("hp_cancel")) {
								...
								/*
								 * Move To MessageTable For L2JTW html.replace("%name%", "(HP Recovery Device)");
								 */
								...
								/*
								 * Move To MessageTable For L2JTW + "</font>Adena /"
								 */
								+ "</font>" + MessageTable.Messages[658].getMessage() + " /" + String.valueOf(Config.FS_HPREG_FEE_RATIO / 1000 / 60 / 60 / 24)
								/*
								 * Move To MessageTable For L2JTW + " Day</font>)"); html.replace("%use%", "Provides additional HP recovery for clan members in the fortress.<font color=\"00FFFF\">"
								 */
								+ MessageTable.Messages[659].getMessage() + "</font>)");
								...
								html.setFile(player.getHtmlPrefix(), "data/html/fortress/functions-apply.htm");
								/*
								 * Move To MessageTable For L2JTW html.replace("%name%", "(MP Recovery)");
								 */
								 ...
								 * Move To MessageTable For L2JTW + "</font>Adena /"
								 */
								+ "</font>" + MessageTable.Messages[658].getMessage() + " /" + String.valueOf(Config.FS_MPREG_FEE_RATIO / 1000 / 60 / 60 / 24)
								/*
								 * Move To MessageTable For L2JTW + " Day</font>)"); html.replace("%use%", "Provides additional MP recovery for clan members in the fortress.<font color=\"00FFFF\">"
								 */
								+ MessageTable.Messages[659].getMessage() + "</font>)");
								...
								html.setFile(player.getHtmlPrefix(), "data/html/fortress/functions-apply.htm");
								/*
								 * Move To MessageTable For L2JTW html.replace("%name%", "(EXP Recovery Device)");
								 */
								 ...
								 * Move To MessageTable For L2JTW + "</font>Adena /"
								 */
								+ "</font>" + MessageTable.Messages[658].getMessage() + " /" + String.valueOf(Config.FS_EXPREG_FEE_RATIO / 1000 / 60 / 60 / 24)
								/*
								 * Move To MessageTable For L2JTW + " Day</font>)"); html.replace("%use%", "Restores the Exp of any clan member who is resurrected in the fortress.<font color=\"00FFFF\">"
								 */
								+ MessageTable.Messages[659].getMessage() + "</font>)");
						...
						if (getFort().getFunction(Fort.FUNC_RESTORE_HP) != null) {
							/*
							 * Move To MessageTable For L2JTW html.replace("%hp_recovery%", String.valueOf(getFort().getFunction(Fort.FUNC_RESTORE_HP).getLvl()) + "%</font> (<font color=\"FFAABB\">"
							 */
							html.replace("%hp_recovery%", MessageTable.Messages[677].getExtra(1) + String.valueOf(getFort().getFunction(Fort.FUNC_RESTORE_HP).getLvl()) + "%" + MessageTable.Messages[677].getExtra(2) + "</font> (<font color=\"FFAABB\">" + String.valueOf(getFort().getFunction(Fort.FUNC_RESTORE_HP).getLease())
							/*
							 * + "</font>Adena /"
							 */
							+ "</font>" + MessageTable.Messages[658].getMessage() + " /" + String.valueOf(Config.FS_HPREG_FEE_RATIO
							/*
							 * Move To MessageTable For L2JTW / 1000 / 60 / 60 / 24) + " Day)"); html.replace("%hp_period%", "Withdraw the fee for the next time at " + format.format(getFort().getFunction(Fort.FUNC_RESTORE_HP).getEndTime())); html.replace("%change_hp%",
						...
						if (getFort().getFunction(Fort.FUNC_RESTORE_EXP) != null) {
							/*
							 * Move To MessageTable For L2JTW html.replace("%exp_recovery%", String.valueOf(getFort().getFunction(Fort.FUNC_RESTORE_EXP).getLvl()) + "%</font> (<font color=\"FFAABB\">"
							 */
							html.replace("%exp_recovery%", MessageTable.Messages[677].getExtra(1) + String.valueOf(getFort().getFunction(Fort.FUNC_RESTORE_EXP).getLvl()) + "%" + MessageTable.Messages[677].getExtra(2) + "</font> (<font color=\"FFAABB\">" + String.valueOf(getFort().getFunction(Fort.FUNC_RESTORE_EXP).getLease())
							/*
							 * + "</font>Adena /"
							 */
							+ "</font>" + MessageTable.Messages[658].getMessage() + " /" + String.valueOf(Config.FS_EXPREG_FEE_RATIO
							/*
							 * Move To MessageTable For L2JTW / 1000 / 60 / 60 / 24) + " Day)"); html.replace("%exp_period%", "Withdraw the fee for the next time at " + format.format(getFort().getFunction(Fort.FUNC_RESTORE_EXP).getEndTime())); html.replace("%change_exp%",
						...
						if (getFort().getFunction(Fort.FUNC_RESTORE_MP) != null) {
							/*
							 * Move To MessageTable For L2JTW html.replace("%mp_recovery%", String.valueOf(getFort().getFunction(Fort.FUNC_RESTORE_MP).getLvl()) + "%</font> (<font color=\"FFAABB\">"
							 */
							html.replace("%mp_recovery%", MessageTable.Messages[677].getExtra(1) + String.valueOf(getFort().getFunction(Fort.FUNC_RESTORE_MP).getLvl()) + "%" + MessageTable.Messages[677].getExtra(2) + "</font> (<font color=\"FFAABB\">" + String.valueOf(getFort().getFunction(Fort.FUNC_RESTORE_MP).getLease())
							/*
							 * + "</font>Adena /"
							 */
							+ "</font>" + MessageTable.Messages[658].getMessage() + " /" + String.valueOf(Config.FS_MPREG_FEE_RATIO
							/*
							 * Move To MessageTable For L2JTW / 1000 / 60 / 60 / 24) + " Day)"); html.replace("%mp_period%", "Withdraw the fee for the next time at " + format.format(getFort().getFunction(Fort.FUNC_RESTORE_MP).getEndTime())); html.replace("%change_mp%",
						...
						if (st.countTokens() >= 1) {
							...
							if (val.equalsIgnoreCase("tele_cancel")) {
								 ...
								 * Move To MessageTable For L2JTW + "</font>Adena /"
								 */
								+ "</font>" + MessageTable.Messages[658].getMessage() + " /" + String.valueOf(Config.FS_SUPPORT_FEE_RATIO / 1000 / 60 / 60 / 24)
								/*
								 * Move To MessageTable For L2JTW + " Day</font>)"); html.replace("%use%", "Enables the use of supplementary magic.");
								 */
								+ MessageTable.Messages[659].getMessage() + "</font>)");
								 ...
								 * Move To MessageTable For L2JTW + "</font>Adena /"
								 */
								+ "</font>" + MessageTable.Messages[658].getMessage() + " /" + String.valueOf(Config.FS_TELE_FEE_RATIO / 1000 / 60 / 60 / 24)
								/*
								 * Move To MessageTable For L2JTW + " Day</font>)"); html.replace("%use%", "Teleports clan members in a fort to the target <font color=\"00FFFF\">Stage "
								 */
								+ MessageTable.Messages[659].getMessage() + "</font>)");
								html.replace("%use%", MessageTable.Messages[672].getMessage() + "<font color=\"00FFFF\">" + MessageTable.Messages[673].getMessage() + String.valueOf(stage)
								/*
								 * Move To MessageTable For L2JTW + "</font> staging area");
								 */
								+ "</font>" + MessageTable.Messages[674].getMessage());
								...
								if (st.countTokens() >= 1) {
									...
									if (getFort().getFunction(Fort.FUNC_SUPPORT) != null) {
										if (getFort().getFunction(Fort.FUNC_SUPPORT).getLvl() == Integer.parseInt(val)) {
											html.setFile(player.getHtmlPrefix(), "data/html/fortress/functions-used.htm");
											/*
											 * Move To MessageTable For L2JTW html.replace("%val%", "Stage "
											 */
											html.replace("%val%", MessageTable.Messages[673].getMessage() + String.valueOf(val));
											sendHtmlMessage(player, html);
											return;
						...
						if (getFort().getFunction(Fort.FUNC_TELEPORT) != null) {
							/*
							 * Move To MessageTable For L2JTW html.replace("%tele%", "Stage " + String.valueOf(getFort().getFunction(Fort.FUNC_TELEPORT).getLvl())
							 */
							html.replace("%tele%", MessageTable.Messages[677].getExtra(1) + String.valueOf(getFort().getFunction(Fort.FUNC_TELEPORT).getLvl()) + MessageTable.Messages[677].getExtra(2) + MessageTable.Messages[673].getMessage() + "</font> (<font color=\"FFAABB\">" + String.valueOf(getFort().getFunction(Fort.FUNC_TELEPORT).getLease())
							/*
							 * Move To MessageTable For L2JTW + "</font>Adena /"
							 */
							+ "</font>" + MessageTable.Messages[658].getMessage() + " /" + String.valueOf(Config.FS_TELE_FEE_RATIO
							/*
							 * / 1000 / 60 / 60 / 24) + " Day)"); html.replace("%tele_period%", "Withdraw the fee for the next time at " + format.format(getFort().getFunction(Fort.FUNC_TELEPORT).getEndTime())); html.replace("%change_tele%",
						...
						if (getFort().getFunction(Fort.FUNC_SUPPORT) != null) {
							/*
							 * Move To MessageTable For L2JTW html.replace("%support%", "Stage " + String.valueOf(getFort().getFunction(Fort.FUNC_SUPPORT).getLvl())
							 */
							html.replace("%support%", MessageTable.Messages[677].getExtra(1) + String.valueOf(getFort().getFunction(Fort.FUNC_SUPPORT).getLvl()) + MessageTable.Messages[677].getExtra(2) + MessageTable.Messages[673].getMessage() + "</font> (<font color=\"FFAABB\">" + String.valueOf(getFort().getFunction(Fort.FUNC_SUPPORT).getLease())
							/*
							 * Move To MessageTable For L2JTW + "</font>Adena /"
							 */
							+ "</font>" + MessageTable.Messages[658].getMessage() + " /" + String.valueOf(Config.FS_SUPPORT_FEE_RATIO
							/*
							 * Move To MessageTable For L2JTW / 1000 / 60 / 60 / 24) + " Day)"); html.replace("%support_period%", "Withdraw the fee for the next time at " + format.format(getFort().getFunction(Fort.FUNC_SUPPORT).getEndTime())); html.replace("%change_support%",
