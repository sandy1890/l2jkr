...
public final class L2ClanTraderInstance extends L2Npc {
	...
	private void sendHtmlMessage(L2PcInstance player, NpcHtmlMessage html) {
		...
		html.replace("%clanname%", String.valueOf(player.getClan())); // Update by rocknow
		html.replace("%reputation%", String.valueOf(player.getClan().getReputationScore())); // Update by rocknow
