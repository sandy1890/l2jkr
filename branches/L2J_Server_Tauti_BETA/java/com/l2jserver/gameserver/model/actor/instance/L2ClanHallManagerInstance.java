		...
		if (condition == COND_OWNER) {
			...
			if (actualCommand.equalsIgnoreCase("banish_foreigner")) {
					...
					if (val.equalsIgnoreCase("recovery")) {
						if (st.countTokens() >= 1) {
							if (getClanHall().getOwnerId() == 0) {
								/*
								 * Move To MessageTable For L2JTW player.sendMessage("This clan Hall have no owner, you cannot change configuration");
								 */
							...
							if (val.equalsIgnoreCase("hp_cancel")) {
								...
								/*
								 * Move To MessageTable For L2JTW html.replace("%cost%", String.valueOf(cost)+"</font>Adena /"+String.valueOf(Config.CH_HPREG_FEE_RATIO/1000/60/60/24)+" Day</font>)");
								...
								/*
								 * Move To MessageTable For L2JTW html.replace("%cost%", String.valueOf(cost)+"</font>Adena /"+String.valueOf(Config.CH_MPREG_FEE_RATIO/1000/60/60/24)+" Day</font>)");
								...
								/*
								 * Move To MessageTable For L2JTW html.replace("%cost%", String.valueOf(cost)+"</font>Adena /"+String.valueOf(Config.CH_EXPREG_FEE_RATIO/1000/60/60/24)+" Day</font>)");
						...
						if (getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP) != null) {
							/*
							 * Move To MessageTable For L2JTW html.replace("%hp_recovery%", String.valueOf(getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP).getLvl()) +
							 * "%</font> (<font color=\"FFAABB\">"+String.valueOf(getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP).getLease())+"</font>Adena /"+String.valueOf(Config.CH_HPREG_FEE_RATIO/1000/60/60/24)+" Day)"); html.replace("%hp_period%","Withdraw the fee for the next time at " +
						...
						if (getClanHall().getFunction(ClanHall.FUNC_RESTORE_EXP) != null) {
							/*
							 * Move To MessageTable For L2JTW html.replace("%exp_recovery%", String.valueOf(getClanHall().getFunction(ClanHall.FUNC_RESTORE_EXP).getLvl()) +
							 * "%</font> (<font color=\"FFAABB\">"+String.valueOf(getClanHall().getFunction(ClanHall.FUNC_RESTORE_EXP).getLease())+"</font>Adena /"+String.valueOf(Config.CH_EXPREG_FEE_RATIO/1000/60/60/24)+" Day)"); html.replace("%exp_period%", "Withdraw the fee for the next time at "
							...
							switch (grade) {
								case 0:
									/*
									 * Move To MessageTable For L2JTW html.replace("%change_exp%","[<a action=\"bypass -h npc_%objectId%_manage recovery exp_cancel\">Deactivate</a>]"+exp_grade0);
									 */
								...
								case 1:
									/*
									 * Move To MessageTable For L2JTW html.replace("%change_exp%","[<a action=\"bypass -h npc_%objectId%_manage recovery exp_cancel\">Deactivate</a>]"+exp_grade1);
									 */
								...
								case 2:
									/*
									 * Move To MessageTable For L2JTW html.replace("%change_exp%","[<a action=\"bypass -h npc_%objectId%_manage recovery exp_cancel\">Deactivate</a>]"+exp_grade2);
									 */
								...
								case 3:
									/*
									 * Move To MessageTable For L2JTW html.replace("%change_exp%","[<a action=\"bypass -h npc_%objectId%_manage recovery exp_cancel\">Deactivate</a>]"+exp_grade3);
									 */
						...
						if (getClanHall().getFunction(ClanHall.FUNC_RESTORE_MP) != null) {
							/*
							 * Move To MessageTable For L2JTW html.replace("%mp_recovery%", String.valueOf(getClanHall().getFunction(ClanHall.FUNC_RESTORE_MP).getLvl()) +
							 * "%</font> (<font color=\"FFAABB\">"+String.valueOf(getClanHall().getFunction(ClanHall.FUNC_RESTORE_MP).getLease())+"</font>Adena /"+String.valueOf(Config.CH_MPREG_FEE_RATIO/1000/60/60/24)+" Day)"); html.replace("%mp_period%", "Withdraw the fee for the next time at " +
							...
							switch (grade) {
								case 0:
									/*
									 * Move To MessageTable For L2JTW html.replace("%change_mp%","[<a action=\"bypass -h npc_%objectId%_manage recovery mp_cancel\">Deactivate</a>]"+mp_grade0);
									 */
								...
								case 1:
									/*
									 * Move To MessageTable For L2JTW html.replace("%change_mp%","[<a action=\"bypass -h npc_%objectId%_manage recovery mp_cancel\">Deactivate</a>]"+mp_grade1);
									 */
								...
								case 2:
									/*
									 * Move To MessageTable For L2JTW html.replace("%change_mp%","[<a action=\"bypass -h npc_%objectId%_manage recovery mp_cancel\">Deactivate</a>]"+mp_grade2);
									 */
								...
								case 3:
									/*
									 * Move To MessageTable For L2JTW html.replace("%change_mp%","[<a action=\"bypass -h npc_%objectId%_manage recovery mp_cancel\">Deactivate</a>]"+mp_grade3);
									 */
						...
						if (st.countTokens() >= 1) {
							...
							if (val.equalsIgnoreCase("item_cancel")) {
								...
								html.setFile(player.getHtmlPrefix(), "data/html/clanHallManager/functions-apply.htm");
								/*
								 * Move To MessageTable For L2JTW html.replace("%name%", "Magic Equipment (Item Production Facilities)");
								 */
								...
								/*
								 * Move To MessageTable For L2JTW html.replace("%cost%", String.valueOf(cost)+"</font>Adena /"+String.valueOf(Config.CH_ITEM_FEE_RATIO/1000/60/60/24)+" Day</font>)"); html.replace("%use%","Allow the purchase of special items at fixed intervals.");
								 */
								...
								/*
								 * Move To MessageTable For L2JTW html.replace("%cost%", String.valueOf(cost)+"</font>Adena /"+String.valueOf(Config.CH_SUPPORT_FEE_RATIO/1000/60/60/24)+" Day</font>)"); html.replace("%use%","Enables the use of supplementary magic.");
								 */
								...
								/*
								 * Move To MessageTable For L2JTW html.replace("%cost%", String.valueOf(cost)+"</font>Adena /"+String.valueOf(Config.CH_TELE_FEE_RATIO/1000/60/60/24)+" Day</font>)");
						...
						/*
						 * Move To MessageTable For L2JTW String tele = "[<a action=\"bypass -h npc_%objectId%_manage other edit_tele 1\">Level 1</a>][<a action=\"bypass -h npc_%objectId%_manage other edit_tele 2\">Level 2</a>]"; String support_grade0 =
						 * "[<a action=\"bypass -h npc_%objectId%_manage other edit_support 1\">Level 1</a>][<a action=\"bypass -h npc_%objectId%_manage other edit_support 2\">Level 2</a>]"; String support_grade1 =
						 * "[<a action=\"bypass -h npc_%objectId%_manage other edit_support 1\">Level 1</a>][<a action=\"bypass -h npc_%objectId%_manage other edit_support 2\">Level 2</a>][<a action=\"bypass -h npc_%objectId%_manage other edit_support 4\">Level 4</a>]"; String support_grade2 =
						 * "[<a action=\"bypass -h npc_%objectId%_manage other edit_support 3\">Level 3</a>][<a action=\"bypass -h npc_%objectId%_manage other edit_support 4\">Level 4</a>][<a action=\"bypass -h npc_%objectId%_manage other edit_support 5\">Level 5</a>]"; String support_grade3 =
						...
						if (getClanHall().getFunction(ClanHall.FUNC_TELEPORT) != null) {
							/*
							 * Move To MessageTable For L2JTW html.replace("%tele%","Stage "+ String.valueOf(getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl()) +
							 * "</font> (<font color=\"FFAABB\">"+String.valueOf(getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLease())+"</font>Adena /"+String.valueOf(Config.CH_TELE_FEE_RATIO/1000/60/60/24)+" Day)"); html.replace("%tele_period%","Withdraw the fee for the next time at " +
							 * format.format(getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getEndTime())); html.replace("%change_tele%","[<a action=\"bypass -h npc_%objectId%_manage other tele_cancel\">Deactivate</a>]"+tele);
							 */
						...
						if (getClanHall().getFunction(ClanHall.FUNC_SUPPORT) != null) {
							/*
							 * Move To MessageTable For L2JTW html.replace("%support%","Stage "+ String.valueOf(getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLvl()) +
							 * "</font> (<font color=\"FFAABB\">"+String.valueOf(getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLease())+"</font>Adena /"+String.valueOf(Config.CH_SUPPORT_FEE_RATIO/1000/60/60/24)+" Day)"); html.replace("%support_period%","Withdraw the fee for the next time at "
							...
							switch (grade) {
								case 0:
									/*
									 * Move To MessageTable For L2JTW html.replace("%change_support%","[<a action=\"bypass -h npc_%objectId%_manage other support_cancel\">Deactivate</a>]"+support_grade0);
									 */
								...
								case 1:
									/*
									 * Move To MessageTable For L2JTW html.replace("%change_support%","[<a action=\"bypass -h npc_%objectId%_manage other support_cancel\">Deactivate</a>]"+support_grade1);
									 */
								...
								case 2:
									/*
									 * Move To MessageTable For L2JTW html.replace("%change_support%","[<a action=\"bypass -h npc_%objectId%_manage other support_cancel\">Deactivate</a>]"+support_grade2);
									 */
								...
								case 3:
									/*
									 * Move To MessageTable For L2JTW html.replace("%change_support%","[<a action=\"bypass -h npc_%objectId%_manage other support_cancel\">Deactivate</a>]"+support_grade3);
									 */
						...
						if (getClanHall().getFunction(ClanHall.FUNC_ITEM_CREATE) != null) {
							/*
							 * Move To MessageTable For L2JTW html.replace("%item%","Stage "+ String.valueOf(getClanHall().getFunction(ClanHall.FUNC_ITEM_CREATE).getLvl()) +
							 * "</font> (<font color=\"FFAABB\">"+String.valueOf(getClanHall().getFunction(ClanHall.FUNC_ITEM_CREATE).getLease())+"</font>Adena /"+String.valueOf(Config.CH_ITEM_FEE_RATIO/1000/60/60/24)+" Day)"); html.replace("%item_period%","Withdraw the fee for the next time at " +
							 * format.format(getClanHall().getFunction(ClanHall.FUNC_ITEM_CREATE).getEndTime())); html.replace("%change_item%","[<a action=\"bypass -h npc_%objectId%_manage other item_cancel\">Deactivate</a>]"+item);
							 */
							...
							/*
							 * Move To MessageTable For L2JTW html.replace("%item%", "none"); html.replace("%item_period%", "none");
							 */
						...
						if (st.countTokens() >= 1) {
							...
							if (val.equalsIgnoreCase("curtains_cancel")) {
								...
								html.setFile(player.getHtmlPrefix(), "data/html/clanHallManager/functions-apply.htm");
								/*
								 * Move To MessageTable For L2JTW html.replace("%name%", "Curtains (Decoration)");
								 */
								...
								/*
								 * Move To MessageTable For L2JTW html.replace("%cost%", String.valueOf(cost)+"</font>Adena /"+String.valueOf(Config.CH_CURTAIN_FEE_RATIO/1000/60/60/24)+" Day</font>)"); html.replace("%use%","These curtains can be used to decorate the clan hall.");
								 */
								...
								html.setFile(player.getHtmlPrefix(), "data/html/clanHallManager/functions-apply.htm");
								/*
								 * Move To MessageTable For L2JTW html.replace("%name%", "Front Platform (Decoration)");
								 */
								...
								/*
								 * Move To MessageTable For L2JTW html.replace("%cost%", String.valueOf(cost)+"</font>Adena /"+String.valueOf(Config.CH_FRONT_FEE_RATIO/1000/60/60/24)+" Day</font>)"); html.replace("%use%","Used to decorate the clan hall.");
								 */
						...
						/*
						 * Move To MessageTable For L2JTW String curtains = "[<a action=\"bypass -h npc_%objectId%_manage deco edit_curtains 1\">Level 1</a>][<a action=\"bypass -h npc_%objectId%_manage deco edit_curtains 2\">Level 2</a>]"; String fixtures =
						...
						if (getClanHall().getFunction(ClanHall.FUNC_DECO_CURTAINS) != null) {
							/*
							 * Move To MessageTable For L2JTW html.replace("%curtain%","Stage "+ String.valueOf(getClanHall().getFunction(ClanHall.FUNC_DECO_CURTAINS).getLvl()) +
							 * "</font> (<font color=\"FFAABB\">"+String.valueOf(getClanHall().getFunction(ClanHall.FUNC_DECO_CURTAINS).getLease())+"</font>Adena /"+String.valueOf(Config.CH_CURTAIN_FEE_RATIO/1000/60/60/24)+" Day)");
							...
							/*
							 * Move To MessageTable For L2JTW html.replace("%curtain%", "none"); html.replace("%curtain_period%", "none");
							 */
						...
						if (getClanHall().getFunction(ClanHall.FUNC_DECO_FRONTPLATEFORM) != null) {
							/*
							 * Move To MessageTable For L2JTW html.replace("%fixture%","Stage "+ String.valueOf(getClanHall().getFunction(ClanHall.FUNC_DECO_FRONTPLATEFORM).getLvl()) +
							 * "</font> (<font color=\"FFAABB\">"+String.valueOf(getClanHall().getFunction(ClanHall.FUNC_DECO_FRONTPLATEFORM).getLease())+"</font>Adena /"+String.valueOf(Config.CH_FRONT_FEE_RATIO/1000/60/60/24)+" Day)"); html.replace("%fixture_period%",
							 * "Withdraw the fee for the next time at " + format.format(getClanHall().getFunction(ClanHall.FUNC_DECO_FRONTPLATEFORM).getEndTime())); html.replace("%change_fixture%","[<a action=\"bypass -h npc_%objectId%_manage deco fixtures_cancel\">Deactivate</a>]"+fixtures);
							 */
							...
							/*
							 * Move To MessageTable For L2JTW html.replace("%fixture%", "none"); html.replace("%fixture_period%", "none");
							 */
				...
				if (player.isCursedWeaponEquipped()) {
					...
					/*
					 * Move To MessageTable For L2JTW player.sendMessage("The wielder of a cursed weapon cannot receive outside heals or buffs");
					 */
