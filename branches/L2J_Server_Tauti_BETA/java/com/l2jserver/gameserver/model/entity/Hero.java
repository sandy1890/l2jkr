		...
		try {
			...
			while (rset.next()) {
				...
				if (action == ACTION_RAID_KILLED) {
					...
					if (template != null) {
						/*
						 * Move To MessageTable For L2JTW _diaryentry.set("action", template.getName() + " was defeated");
						 */
					...
					/*
					 * Move To MessageTable For L2JTW _diaryentry.set("action", "Gained Hero status");
					 */
					...
					if (castle != null) {
						/*
						 * Move To MessageTable For L2JTW _diaryentry.set("action", castle.getName()+" Castle was successfuly taken");
						 */
			...
			while (rset.next()) {
				...
				if (charId == charOneId) {
					...
					if ((name != null) && (cls != null)) {
						...
						if (winner == 1) {
							/*
							 * Move To MessageTable For L2JTW fight.set("result", "<font color=\"00ff00\">victory</font>");
							 */
							fight.set("result", "<font color=\"00ff00\">" + MessageTable.Messages[448].getMessage() + "</font>");
							_victorys++;
						} else if (winner == 2) {
							/*
							 * Move To MessageTable For L2JTW fight.set("result", "<font color=\"ff0000\">loss</font>");
							 */
							fight.set("result", "<font color=\"ff0000\">" + MessageTable.Messages[452].getMessage() + "</font>");
							_losses++;
						} else if (winner == 0) {
							/*
							 * Move To MessageTable For L2JTW fight.set("result", "<font color=\"ffff00\">draw</font>");
							 */
			...
			if ((htmContent != null) && _heroMessage.containsKey(charid)) {
				...
				if (!_mainlist.isEmpty()) {
					...
					for (int i = ((page - 1) * perpage); i < _list.size(); i++) {
						...
						/*
						 * Move To MessageTable For L2JTW StringUtil.append(fList, "<tr><td width=270><font color=\"LEVEL\">" + _diaryentry.getString("date") + ":xx</font></td></tr>");
						 */
					...
					if (breakat < (_list.size() - 1)) {
						/*
						 * Move To MessageTable For L2JTW DiaryReply.replace("%buttprev%", "<button value=\"Prev\" action=\"bypass _diary?class=" + heroclass + "&page=" + (page + 1) + "\" width=60 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
						 */
					...
					if (page > 1) {
						/*
						 * Move To MessageTable For L2JTW DiaryReply.replace("%buttnext%", "<button value=\"Next\" action=\"bypass _diary?class=" + heroclass + "&page=" + (page - 1) + "\" width=60 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
						 */
			...
			if (htmContent != null) {
				...
				if (!_list.isEmpty()) {
					...
					for (int i = ((page - 1) * perpage); i < _list.size(); i++) {
						...
						/*
						 * Move To MessageTable For L2JTW StringUtil.append(fList, "<tr><td width=220><font color=\"LEVEL\">" + fight.getString("start") + "</font>&nbsp;&nbsp;" + fight.getString("result") + "</td><td width=50 align=right>" + (fight.getInteger("classed") > 0 ?
						 * "<font color=\"FFFF99\">cls</font>" : "<font color=\"999999\">non-cls<font>") + "</td></tr>");
						 */
						StringUtil.append(fList, "<tr><td width=220><font color=\"LEVEL\">" + fight.getString("start") + "</font>&nbsp;&nbsp;" + fight.getString("result") + "</td><td width=50 align=right>" + (fight.getInteger("classed") > 0 ? "<font color=\"FFFF99\">" + MessageTable.Messages[456].getMessage() + "</font>" : "<font color=\"999999\">" + MessageTable.Messages[462].getMessage() + "<font>") + "</td></tr>");
					...
					if (breakat < (_list.size() - 1)) {
						/*
						 * Move To MessageTable For L2JTW FightReply.replace("%buttprev%", "<button value=\"Prev\" action=\"bypass _match?class=" + heroclass + "&page=" + (page + 1) + "\" width=60 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
						 */
					...
					if (page > 1) {
						/*
						 * Move To MessageTable For L2JTW FightReply.replace("%buttnext%", "<button value=\"Next\" action=\"bypass _match?class=" + heroclass + "&page=" + (page - 1) + "\" width=60 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
						 */
