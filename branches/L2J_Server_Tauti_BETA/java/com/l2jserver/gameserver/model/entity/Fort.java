...
public class Fort {
	...
	private void load() {
		...
		try {
			...
			while (rs.next()) {
				...
				switch (getFortId()) {
					case 101:
						_cname = MessageTable.Messages[1950].getMessage();
					break;
					case 102:
						_cname = MessageTable.Messages[1951].getMessage();
					break;
					case 103:
						_cname = MessageTable.Messages[1952].getMessage();
					break;
					case 104:
						_cname = MessageTable.Messages[1953].getMessage();
					break;
					case 105:
						_cname = MessageTable.Messages[1954].getMessage();
					break;
					case 106:
						_cname = MessageTable.Messages[1955].getMessage();
					break;
					case 107:
						_cname = MessageTable.Messages[1956].getMessage();
					break;
					case 108:
						_cname = MessageTable.Messages[1957].getMessage();
					break;
					case 109:
						_cname = MessageTable.Messages[1958].getMessage();
					break;
					case 110:
						_cname = MessageTable.Messages[1959].getMessage();
					break;
					case 111:
						_cname = MessageTable.Messages[1960].getMessage();
					break;
					case 112:
						_cname = MessageTable.Messages[1961].getMessage();
					break;
					case 113:
						_cname = MessageTable.Messages[1962].getMessage();
					break;
					case 114:
						_cname = MessageTable.Messages[1963].getMessage();
					break;
					case 115:
						_cname = MessageTable.Messages[1964].getMessage();
					break;
					case 116:
						_cname = MessageTable.Messages[1965].getMessage();
					break;
					case 117:
						_cname = MessageTable.Messages[1966].getMessage();
					break;
					case 118:
						_cname = MessageTable.Messages[1967].getMessage();
					break;
					case 119:
						_cname = MessageTable.Messages[1968].getMessage();
					break;
					case 120:
						_cname = MessageTable.Messages[1969].getMessage();
					break;
					case 121:
						_cname = MessageTable.Messages[1970].getMessage();
					break;
					default:
						_cname = MessageTable.Messages[1971].getMessage();
				}
	...
	private void loadDoor() {
		...
		if (Config.DEBUG) {
			_log.info(this + " 요새 " + _doors.size() + "개 문이 로드되었습니다.");
		}
	}
