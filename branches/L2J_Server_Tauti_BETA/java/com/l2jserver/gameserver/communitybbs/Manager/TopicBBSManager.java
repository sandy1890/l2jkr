...
public class TopicBBSManager extends BaseBBSManager {
	...
	private void showMemoTopics(Forum forum, L2PcInstance activeChar, int index) {
		 ...
		 */
		+ "<a action=\"bypass _bbshome\">" + MessageTable.Messages[124].getMessage() + "</a>&nbsp;>&nbsp;<a action=\"bypass _bbsmemo\">" + MessageTable.Messages[125].getMessage() + "</a>" + "</td></tr>" + "</table>" + "<img src=\"L2UI.squareblank\" width=\"1\" height=\"10\">" + "<center>" + "<table border=0 cellspacing=0 cellpadding=2 bgcolor=888888 width=610>" + "<tr>" + "<td FIXWIDTH=5></td>" + "<td FIXWIDTH=415 align=center>&$413;</td>" + "<td FIXWIDTH=120 align=center></td>" + "<td FIXWIDTH=70 align=center>&$418;</td>" + "</tr>" + "</table>");
