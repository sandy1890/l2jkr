...
public final class NpcStringId {
	...
	public static final NpcStringId YOU_CANT_RIDE_A_KOOKARU_NOW; // rocknow-God
	public static final NpcStringId BEGIN_TUTORIAL_QUESTS; // rocknow-God
	public static final NpcStringId NEWBIE_HELPER_HAS_CASTED_BUFFS_ON_S1; // rocknow-God
	/**
	...
	static {
		...
		YOU_CANT_RIDE_A_KOOKARU_NOW = new NpcStringId(1811297); // rocknow-God
		BEGIN_TUTORIAL_QUESTS = new NpcStringId(1600026); // rocknow-God
		NEWBIE_HELPER_HAS_CASTED_BUFFS_ON_S1 = new NpcStringId(1600027); // rocknow-God
