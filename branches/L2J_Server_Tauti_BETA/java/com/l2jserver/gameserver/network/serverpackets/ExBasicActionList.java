...
public final class ExBasicActionList extends L2GameServerPacket {
	...
	static {
		int count1 = 89; // 0 <-> (count1 - 1) //rocknow-God
		int count2 = 124; // 1000 <-> (1000 + count2 - 1) //Update by rocknow //rocknow-God
		int count3 = 17; // 5000 <-> (5000 + count3 - 1) //Update by rocknow //rocknow-God
