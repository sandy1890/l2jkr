...
public final class RequestRecipeItemMakeSelf extends L2GameClientPacket {
	...
	protected void runImpl() {
		...
		if (activeChar.getPrivateStoreType() != 0) {
			/*
			 * Move To MessageTable For L2JTW activeChar.sendMessage("You cannot create items while trading.");
			 */
		...
		if (activeChar.isInCraftMode()) {
			/*
			 * Move To MessageTable For L2JTW activeChar.sendMessage("You are currently in Craft Mode.");
			 */
