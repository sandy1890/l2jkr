...
public class Shutdown extends Thread {
	...
	/**
	 * A simple class used to track down the estimated time of method executions. Once this class is created, it saves the start time, and when you want to get the estimated time, use the getEstimatedTime() method.
	 */
