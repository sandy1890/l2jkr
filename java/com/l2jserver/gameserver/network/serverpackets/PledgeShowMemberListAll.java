...
/**
 * sample from gracia final: 5A // packet id 00 00 00 00 // pledge = 1 subpledge = 0 D0 2D 00 00 // clan ID 00 00 00 00 // pledge Id 54 00 68 00 65 00 4B 00 6E 00 69 00 67 00 68 00 74 00 73 00 4F 00 66 00 47 00 6F 00 64 00 00 00 // clan name 54 00 68 00 65 00 47 00 72 00 65 00 65 00 6E 00 44 00 72
 * 00 61 00 67 00 30 00 6E 00 00 00 // clan leader 9D 4F 01 00 // crest ID 03 00 00 00 // level 00 00 00 00 // castle id 00 00 00 00 // hideout id 00 00 00 00 // fort id 00 00 00 00 // rank 00 00 00 00 // reputation 00 00 00 00 // ? 00 00 00 00 // ? 00 00 00 00 // ally id 00 00 // ally name 00 00 00
 * 00 // ally crest id 00 00 00 00 // is at war 00 00 00 00 // territory castle ID 01 00 00 00 // member count 51 00 75 00 65 00 65 00 70 00 68 00 00 00 // member name 22 00 00 00 // member level 07 00 00 00 // member class id 01 00 00 00 // member sex 00 00 00 00 // member race 00 00 00 00 //
 * member object id (if online) 00 00 00 00 // member sponsor format dddSS ddddddddddSddd d (Sdddddd)
