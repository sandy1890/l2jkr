...
public final class SystemMessage extends L2GameServerPacket {
	...
	private static final byte TYPE_DAMAGE = 16; // rocknow-God (by otfnir)
	...
	private final void append(final SMParam param) {
		if (_paramIndex >= _params.length) {
			...
			// rocknow-God-Show Damage-TEST Only _log.log(Level.INFO, "Wrong parameter count '" + (_paramIndex + 1) + "' for SystemMessageId: " + _smId);
		}
