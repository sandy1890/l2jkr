...
public final class PetitionManager {
	...
	public void sendPendingPetitionList(L2PcInstance activeChar) {
		...
		/*
		 * Move To MessageTable For L2JTW + "<td width=45><button value=\"Main\" action=\"bypass -h admin_admin\" width=45 height=21 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>" + "<td width=180><center>Petition Menu</center></td>" +
		...
		for (Petition currPetition : getPendingPetitions().values()) {
			...
			if (currPetition.getState() != PetitionState.In_Process) {
				...
				/*
				 * Move To MessageTable For L2JTW + "<td><button value=\"View\" action=\"bypass -h admin_view_petition ", String.valueOf(currPetition.getId()), "\" width=\"50\" height=\"21\" back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>" +
				 ...
				 */
				+ "<td><button value=\"" + MessageTable.Messages[196].getMessage() + "\" action=\"bypass -h admin_view_petition ", String.valueOf(currPetition.getId()), "\" width=\"50\" height=\"21\" back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>" + "<td><button value=\"" + MessageTable.Messages[197].getMessage() + "\" action=\"bypass -h admin_reject_petition ", String.valueOf(currPetition.getId()), "\" width=\"50\" height=\"21\" back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr></table>");
			} else {
			...
			if (petcount > 10) {
				/*
				 * Move To MessageTable For L2JTW htmlContent.append("<tr><td><font color=\"LEVEL\">There is more pending petition...</font><br></td></tr>");
				 */
	...
	public int submitPetition(L2PcInstance petitioner, String petitionText, int petitionType) {
		...
		/*
		 * Move To MessageTable For L2JTW String msgContent = petitioner.getName() + " has submitted a new petition."; //(ID: " + newPetitionId + ")."; AdminTable.getInstance().broadcastToGMs(new CreatureSay(petitioner.getObjectId(), Say2.HERO_VOICE, "Petition System", msgContent));
		 */
