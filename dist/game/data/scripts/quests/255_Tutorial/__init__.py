...
QMCa = {
    ...
    44 : ["tutorial_orc_fighter017.htm",-46324,-114384,-200],     #增加半獸人戰士的對話
    49 : ["tutorial_orc_mage017.htm",-46305,-112763,-200],        #增加半獸人法師的對話
    53 : ["tutorial_dwarven017.htm",115447,-182672,-1440],        #增加矮人的對話
          ...
          if event[2:].isdigit() :
            ...
            if event_id == 1 :
                ...
                if playerLevel == 5 and player.getClassId().level() == 0:
                   if st.getInt("lvl") < 5 :
                    if not player.getClassId().isMage() and classId != 49: #修正半獸人法師等級判斷-1
                   ...
                   st.set("lvl","6")
                elif playerLevel == 7 and player.getClassId().isMage() or playerLevel == 7 and classId == 49: #修正半獸人法師等級判斷-2
