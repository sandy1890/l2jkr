...
public class AdminVitaminItem implements IAdminCommandHandler {
	...
	public void main_txt(L2PcInstance player) {
		...
		sb.append("<tr><td>�п�J�z�Q�гy�����~�s���B�Ωһݼƶq�C<font color=\"LEVEL\">�`�N: �Фųгy�h�ӵL�k���|�����~</font></td></tr>");
		sb.append("<tr><td>�s��:</td></tr>");
		sb.append("<tr><td><td><edit width=120 var=\"tsId\"></td></tr>");
		sb.append("<tr><td</td></tr>");
		sb.append("<tr><td>�ƶq:</td></tr>");
		...
		sb.append("<table width=270>");
		sb.append("<tr>");
		sb.append("<td><button value=\"�e�X���~\" width=80 action=\"bypass -h admin_sendVitem $tsId $tsCnt $tsPpl\" height=21 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		sb.append("</tr>");
