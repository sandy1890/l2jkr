...
public class AdminAdmin implements IAdminCommandHandler {
	...
	public void showConfigPage(L2PcInstance activeChar) {
		...
		TextBuilder replyMSG = new TextBuilder("<html><title>" + MessageTable.Messages[1406].getMessage() + "</title><body>");
		replyMSG.append("<center><table width=270><tr><td width=60><button value=\"" + MessageTable.Messages[1393].getMessage() + "\" action=\"bypass -h admin_admin\" width=60 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td><td width=150><center>" + MessageTable.Messages[1394].getMessage() + "</center></td><td width=60><button value=\"" + MessageTable.Messages[1395].getMessage() + "\" action=\"bypass -h admin_admin4\" width=60 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr></table></center><br>");
