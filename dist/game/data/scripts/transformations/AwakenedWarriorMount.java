...
public class AwakenedWarriorMount extends L2Transformation {
	...
	public static void main(String[] args) {
		TransformationManager.getInstance().registerTransformation(new AwakenedWarriorMount());
	}
}
