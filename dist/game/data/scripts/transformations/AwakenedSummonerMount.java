...
public class AwakenedSummonerMount extends L2Transformation
{
	...
	{
		if ((getPlayer().getTransformationId() != 134) || getPlayer().isCursedWeaponEquipped())
		{
			return;
		}
	...
	{
		TransformationManager.getInstance().registerTransformation(new AwakenedSummonerMount());
	}
}
