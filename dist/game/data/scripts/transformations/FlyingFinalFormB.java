...
public class FlyingFinalFormB extends L2Transformation {
	...
	public void onTransform() {
		if ((getPlayer().getTransformationId() != 507) || getPlayer().isCursedWeaponEquipped()) {
			return;
		}
	...
	public static void main(String[] args) {
		TransformationManager.getInstance().registerTransformation(new FlyingFinalFormB());
	}
}
