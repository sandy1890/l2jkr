...
(29001, -21610, 181594, -5734, 0, 0, 229898.48, 667.776, 0), -- 여왕 개미 (40)
(29006, 17726, 108915, -6480, 0, 0, 622493.58388, 3793.536, 0), -- 코어 (50)
(29014, 55024, 17368, -5412, 10126, 0, 622493.58388, 3793.536, 0), -- 오르펜 (50)
(29019, 185708, 114298, -8221, 32768, 0, 17850000, 39960, 0), -- 안타라스 (79)
(29020, 116033, 17447, 10104, 40188, 0, 4068372, 39960, 0), -- 바이움 (75)
(29022, 55312, 219168, -3223, 0, 0, 858518.36, 399600, 0), -- 자켄 (60)
(29028, -105200, -253104, -15264, 0, 0, 223107426.1796109, 4497143.692870192, 0), -- 발라카스 (85)
(29066, 185708, 114298, -8221,32768, 0, 14518000, 3996000, 0), -- 안타라스 (79)
(29067, 185708, 114298, -8221,32768, 0, 16184000, 3996000, 0), -- 안타라스 (79)
(29068, 185708, 114298, -8221,32768, 0, 204677324.07859, 3996000, 0), -- 안타라스 (85)
(29045, 0, 0, 0, 0, 0, 1018821.42723286, 52001.06567747795, 0), -- 프린테사 (85)
(29065, -123348, -248881, -15537, 44732, 0, 1532678, 4255, 0), -- 사이렌 (87)
(29099, 153569, 142075, -12732, 60025, 0, 1448567, 3718, 0), -- 발러
...
-- 레이드 보스 NPC 업데이트
UPDATE `npc`, `raidboss_spawnlist` SET
	`raidboss_spawnlist`.`heading` = 0,
	`raidboss_spawnlist`.`currentHp` = `npc`.`hp`,
	`raidboss_spawnlist`.`currentMp` = `npc`.`mp`
